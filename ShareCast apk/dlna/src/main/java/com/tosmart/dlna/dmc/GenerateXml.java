...
import com.tosmart.dlna.dmp.ContentItem;
...
public class GenerateXml {
    ...
    public String generate(Item item) throws Exception {
        return documentToString(buildDOM(item, false), false);
    }

    public String generate(ContentItem item) throws Exception {
    ...
    protected Document buildDOM(Item entity, boolean nestedItems)
            throws Exception {
        ...
        generateRoot(entity, d, nestedItems);

        return d;
    }

    protected void generateRoot(Item entity, Document descriptor,
                                boolean nestedItems) {
        ...
        if (null != entity) {
            generateItem(entity, descriptor, rootElement);
        }
    }
    ...
    protected void generateResource(Res resource, Document descriptor,
        ...
        if (resource.getRealPath() != null)
            resourceElement
                    .setAttribute("realPath", resource.getRealPath());
    }
	...
	protected void appendClass(Document descriptor, Element parent,
		...
		if (clazz.getFriendlyName() != null
			...
			classElement.setAttribute(Constant.KEY_NAME, clazz.getFriendlyName());
		if (appendDerivation)

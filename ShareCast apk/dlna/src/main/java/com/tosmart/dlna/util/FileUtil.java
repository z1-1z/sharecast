...
import com.tosmart.dlna.util.DevMountInfo.DevInfo;
...
public class FileUtil {
	...
	public static String getFoldName(String path) {
		...
		if (null != sdPath && !TextUtils.isEmpty(path) && path.contains(sdPath) && path.contains(sdPath)) {
			...
			if (null != outSdPath && !TextUtils.isEmpty(outSdPath) && path.contains(outSdPath)) {

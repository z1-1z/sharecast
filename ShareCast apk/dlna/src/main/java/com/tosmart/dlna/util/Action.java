...
public class Action {
	...
	public static final String PLAY_ERROR = "com.video.play.error";
	public static final String CONNECTION_FAILED = "com.connection.failed";
	public static final String PLAY_TRANSPORT_INFO = "com.transport.info";
	public static final String PLAY_TRANSPORT_STATE = "transport.state";
}

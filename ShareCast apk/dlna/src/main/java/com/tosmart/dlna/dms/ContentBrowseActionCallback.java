...
import com.tosmart.dlna.application.ConfigData;
		...
		activity.runOnUiThread(new Runnable() {
			public void run() {
				try {
					...
					handler.sendEmptyMessage(Constant.CONTENT_GET_FAIL);
				}
				...
				handler.sendEmptyMessage(Constant.CONTENT_GET_SUC);
			}
		});
	}

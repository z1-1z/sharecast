...
public abstract class ActionCallback implements Runnable {
    ...
    public void run() {
        Log.i(TAG, getClass().getSimpleName() + "[xxx] run: ");
        Service service = actionInvocation.getAction().getService();

        // Local execution
        if (service instanceof LocalService) {
            Log.i(TAG, getClass().getSimpleName() + "[xxx] LocalService: ");
        ...
        // Remote execution
            ...
            Log.i(TAG, getClass().getSimpleName() + "[xxx] RemoteService: ");
            ...
            Log.i(TAG, getClass().getSimpleName() + "[xxx] response: " + response);
            if (response == null) {
                failure(actionInvocation, null);

...
public class Res {
    ...
    public Res(MimeType httpGetMimeType, Long size, String value, String realPath) {
        this(new ProtocolInfo(httpGetMimeType), size, value, realPath);
    }

    public Res(ProtocolInfo protocolInfo, Long size, String value, String realPath) {
